...
public class modificarproducto extends HttpServlet {
 ...
 public void init()
    ...
    public String modificar(String modificarproducto)
    {
        String html="";
        ...
        try
        {
         ...
         int fila=mod.executeUpdate(modificarproducto);
         return html+=fila+"PRODUCTO MODIFICADO";
        }
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String  modificarproducto="UPDATE productos SET nombre='"+nombre+"',marca='"+marca+"',precio='"+precio+"' where clave="+clave;
            ...
            out.println(""+modificar(modificarproducto));
            out.println("</form>");
